...
import {BsPerson, BsEnvelope, BsLock, BsTelephone, BsEyeFill, BsEyeSlashFill} from "react-icons/bs";
    ...
    return (
      <div className='bg-[#F5F5F5] h-screen'>
            <Center className="h-full">
                ...
                <img src="/logo.svg" width={100} height={100}></img><br></br>
                ...
                <div className="text-[#1C3B5A] mt-6">
                        ...
                        <InputGroup className="mt-8 bg-[#FFFFFF]" size='lg'>
                            ...
                            <Input pr='4.5rem' rounded={'2xl'} value={password} onChange={handlePass}
                            type={show ? 'text' : 'password'} placeholder='Password'/>
                            <InputRightElement width='4.5rem'>
                                <Button h='1.75rem' size='sm' onClick={handleClick}>
                                {show ? <BsEyeSlashFill color='##1C3B5A' /> : <BsEyeFill color='##1C3B5A' /> }
                                </Button>
                            </InputRightElement>
                        </InputGroup>
                </div>
